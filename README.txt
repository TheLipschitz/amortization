This program takes several user inputs to determine a full amortization schedule for a mortgage.
You can use this tool to help get an idea of how adding principal payments each month or increasing your down 
payment can affect the loan in the long term. 

The user can enter their own numbers for each prompt (if you aren't sure of a number on a specific question like PMI or 
